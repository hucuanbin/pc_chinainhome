 ...
 * $(".container").yxMobileSlider();
  ...
  $(".slider2").yxMobileSlider2({ width: 457, height: 208, during: 5000, shuzu: a222 })
 */
(function($){
    $.fn.yxMobileSlider = function(settings){
        ...
        return this.each(
            ...
            $("img", oLi).css({
                ...
                //初始化焦点容器及按钮
            $(".index_lunb_bt").text(biaoti[iCurr]);
            $(".index_lunb_nr").text(nr[iCurr]);
            ...
            function doMove() {
                ...
                $(".index_lunb_bt").text(biaoti[iCurr]);
                $(".index_lunb_nr").text(nr[iCurr]);
                $(".index_lunb_bt").attr("href", lianjie[iCurr]);
            }
            //绑定触摸事件
